...
```sh
curl -fsSL https://github.com/nhz2/install-julia.sh/releases/download/v0.1.0/install-julia.sh | sh
```

## Install

```sh
curl -fsSLO https://github.com/nhz2/install-julia.sh/releases/download/v0.1.0/install-julia.sh   # or just copy the file
